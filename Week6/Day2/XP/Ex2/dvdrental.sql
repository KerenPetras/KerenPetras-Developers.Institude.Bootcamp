...
--- DVD RENTAL RESTORE; WEEK 6 DAY2
...
SELECT create_date,COUNT(*) AS CNT FROM customer GROUP BY create_date HAVING COUNT(*) > 1;
...
SELECT address,phone,district FROM address WHERE district ILIKE 'Texas';
